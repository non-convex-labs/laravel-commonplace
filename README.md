...
default theme handles light/dark via `prefers-color-scheme` — no toggle
...
precedence over the package's bundled views — useful for restructuring
or rebranding.
...
the layout. Example: a stark light/dark with brand color:
